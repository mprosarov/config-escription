...
const Page = (function () {
  ...
  //===========================================
  // Вот основная функция построения макета
  // короткая и не перегруженная
  // из нее уже можно смотреть что где происходит, если в конфиге встретился тот или иной элемент
  //============================================
